...
const StartDateField: React.FC<{
  ...
  return (
    <div className="my-2">
      <Label htmlFor="startDate" text="Ngày bắt đầu" /> 
      <Controller
        control={control}
        name="startDate"
          ...
          return (
            <Fragment>
              <label htmlFor="startDate" className="sr-only">
                Chọn ngày bắt đầu thời gian làm việc
              </label>
              <input
                {...register("startDate", {
                  required: true,
      ...
      />
      <Error trigger={errors.startDate} message="Ngày bắt đầu là bắt buộc" /> {/* Dịch: Start date is required */}
    </div>
  );
};
