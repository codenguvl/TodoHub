...
const Members = () => {
  ...
  return (
    <div className="flex items-center">
        ...
        return (
          <div key={member.id} style={{ zIndex: 10 - index }}>
            <Button
              ...
              className="-mx-1 flex border-spacing-2 rounded-full border-2 border-transparent bg-white p-0.5 transition-all duration-75 hover:bg-gray-200 [&[data-state=selected]]:border-inprogress"
            >
      ...
      {/* <NotImplemented feature="thêm người">
        <button>
          <AddPeopleIcon
